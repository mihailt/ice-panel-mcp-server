...
import { registerTagsTools } from '../../src/generated/tags';
import { IcePanelClient } from '@icepanel/sdk';
import { McpServer } from '@modelcontextprotocol/sdk/server/mcp.js';

describe('tags tools (Generated)', () => {
    it('should register and execute all tags tools on the server', async () => {
        ...
        registerTagsTools(mockServer, mockClient);
        ...
        for (const [name, callback] of registeredTools.entries()) {
             ...
             if ('tags' === 'find_tool' && name === 'find_tool') {
             ...
             if ('tags' === 'find_tool' && name === 'run_tool') {
