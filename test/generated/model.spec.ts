...
import { registerModelTools } from '../../src/generated/model';
import { IcePanelClient } from '@icepanel/sdk';
import { McpServer } from '@modelcontextprotocol/sdk/server/mcp.js';

describe('model tools (Generated)', () => {
    it('should register and execute all model tools on the server', async () => {
        ...
        registerModelTools(mockServer, mockClient);
        ...
        for (const [name, callback] of registeredTools.entries()) {
             ...
             if ('model' === 'find_tool' && name === 'find_tool') {
             ...
             if ('model' === 'find_tool' && name === 'run_tool') {
