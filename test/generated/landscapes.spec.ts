...
import { registerLandscapesTools } from '../../src/generated/landscapes';
import { IcePanelClient } from '@icepanel/sdk';
import { McpServer } from '@modelcontextprotocol/sdk/server/mcp.js';

describe('landscapes tools (Generated)', () => {
    it('should register and execute all landscapes tools on the server', async () => {
        ...
        registerLandscapesTools(mockServer, mockClient);
        ...
        for (const [name, callback] of registeredTools.entries()) {
             ...
             if ('landscapes' === 'find_tool' && name === 'find_tool') {
             ...
             if ('landscapes' === 'find_tool' && name === 'run_tool') {
