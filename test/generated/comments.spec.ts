...
import { registerCommentsTools } from '../../src/generated/comments';
import { IcePanelClient } from '@icepanel/sdk';
import { McpServer } from '@modelcontextprotocol/sdk/server/mcp.js';

describe('comments tools (Generated)', () => {
    it('should register and execute all comments tools on the server', async () => {
        ...
        registerCommentsTools(mockServer, mockClient);
        ...
        for (const [name, callback] of registeredTools.entries()) {
             ...
             if ('comments' === 'find_tool' && name === 'find_tool') {
             ...
             if ('comments' === 'find_tool' && name === 'run_tool') {
