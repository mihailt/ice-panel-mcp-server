...
import { registerCatalogTools } from '../../src/generated/catalog';
import { IcePanelClient } from '@icepanel/sdk';
import { McpServer } from '@modelcontextprotocol/sdk/server/mcp.js';

describe('catalog tools (Generated)', () => {
    it('should register and execute all catalog tools on the server', async () => {
        ...
        registerCatalogTools(mockServer, mockClient);
        ...
        for (const [name, callback] of registeredTools.entries()) {
             ...
             if ('catalog' === 'find_tool' && name === 'find_tool') {
             ...
             if ('catalog' === 'find_tool' && name === 'run_tool') {
