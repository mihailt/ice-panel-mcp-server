...
import { registerShareLinkTools } from '../../src/generated/shareLink';
import { IcePanelClient } from '@icepanel/sdk';
import { McpServer } from '@modelcontextprotocol/sdk/server/mcp.js';

describe('shareLink tools (Generated)', () => {
    it('should register and execute all shareLink tools on the server', async () => {
        ...
        registerShareLinkTools(mockServer, mockClient);
        ...
        for (const [name, callback] of registeredTools.entries()) {
             ...
             if ('shareLink' === 'find_tool' && name === 'find_tool') {
             ...
             if ('shareLink' === 'find_tool' && name === 'run_tool') {
