/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 64fca01126888a571ea370775732da4d)
// Runtime types generated with workerd@1.20260317.1 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IcePanelMcp";
	}
	interface Env {
		E2E_TEST_ICEPANEL_API_KEY: string;
		DOCKER_ICEPANEL_API_KEY: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").IcePanelMcp>;
	}
}
